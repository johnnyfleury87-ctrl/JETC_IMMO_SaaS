-- ============================================
-- MIGRATION M16 : Ajouter catégorie 'ventilation' dans contrainte CHECK
-- ============================================
-- Date: 2025-12-26
-- Contexte: La catégorie 'ventilation' existe dans l'API mais pas dans check_sous_categorie_valide
-- Problème: Tickets ventilation rejets par contrainte CHECK
-- Solution: Ajouter ventilation avec ses sous-catégories
-- ============================================

BEGIN;

-- DROP contrainte existante
ALTER TABLE public.tickets 
  DROP CONSTRAINT IF EXISTS check_sous_categorie_valide;

-- Recréer contrainte avec ventilation
ALTER TABLE public.tickets 
